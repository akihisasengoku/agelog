...
$(function(){
  $('#ageSubmit, #wantSubmit').on('click', function(){
    $('#ageSubmit, #wantSubmit').attr("disabled", true);
  });
});
(function() {
...
(function() {
  $(function() {
    return $('#followBtn').hover(function() {
      if ($('#followBtn').hasClass('unfollow')) {
        return $(this).text("フォロー解除");
      }
    }, function() {
      if ($('#followBtn').hasClass('unfollow')) {
        return $(this).text("フォロー中");
      }
    });
  });
...
(function() {
  $(function() {
    var topAreaMap, topAreaMapSrc;
    topAreaMap = $('#topAreaMap');
    topAreaMapSrc = topAreaMap.attr('src');
    return $('#topAreaMapTag').children().each(function() {
      return $(this).hover(function() {
        return topAreaMap.attr('src', $(this).attr('alt'));
      }, function() {
        return topAreaMap.attr('src', topAreaMapSrc);
      });
    });
  });
